...
use App\MainBundle\Form\MedicalkindType;
use App\MainBundle\Filter\MedicalkindFilterType;
...
class MedicalkindController extends Controller
{
    ...
    public function indexAction()
    {
		...
		$filterBuilder = $this->get('doctrine.orm.entity_manager')
			->getRepository('MainBundle:Medicalkind')
		...
		return $this->render('MainBundle:Medicalkind:index.html.twig', array(
			'entities' => $entities,
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('MainBundle:Medicalkind:new.html.twig', array(
            'entity' => $entity,
            'form'   => $form->createView(),
        ));
    }
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('MainBundle:Medicalkind')->find($id);
        ...
        return $this->render('MainBundle:Medicalkind:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('MainBundle:Medicalkind:edit.html.twig', array(
            'entity'      => $entity,
