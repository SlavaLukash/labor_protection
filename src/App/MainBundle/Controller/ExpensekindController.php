...
use App\MainBundle\Form\ExpensekindType;
use App\MainBundle\Filter\ExpensekindFilterType;
...
class ExpensekindController extends Controller
{
    ...
    public function indexAction()
    {
		...
		$filterBuilder = $this->get('doctrine.orm.entity_manager')
			->getRepository('MainBundle:Expensekind')
		...
		return $this->render('MainBundle:Expensekind:index.html.twig', array(
			'entities' => $entities,
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('MainBundle:Expensekind:new.html.twig', array(
            'entity' => $entity,
            'form'   => $form->createView(),
        ));
    }
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('MainBundle:Expensekind')->find($id);
        ...
        return $this->render('MainBundle:Expensekind:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('MainBundle:Expensekind:edit.html.twig', array(
            'entity'      => $entity,
