...
use App\MainBundle\Form\ReportType;
...
class ReportController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('MainBundle:Report')->findAll();

        return $this->render('MainBundle:Report:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('MainBundle:Report:new.html.twig', array(
            'entity' => $entity,
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('MainBundle:Report')->find($id);
        ...
        return $this->render('MainBundle:Report:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('MainBundle:Report:edit.html.twig', array(
            'entity'      => $entity,
    ...
    */
	...
	public function listAction($Categoryid = null) {
		...
		$CategoryReportEntities = $em->getRepository('MainBundle:CategoryReport')->findAll();
		...
		$entities = $em->getRepository('MainBundle:Report')->findByCategoryreport($Categoryid);

		return $this->render('MainBundle:Report:list.html.twig', array(
			'entities' 						=> $entities,
