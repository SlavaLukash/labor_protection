...
use App\MainBundle\Form\MedicaltypeType;
use App\MainBundle\Filter\MedicaltypeFilterType;
...
class MedicaltypeController extends Controller
{
    ...
    public function indexAction()
    {
		...
		$filterBuilder = $this->get('doctrine.orm.entity_manager')
			->getRepository('MainBundle:Medicaltype')
		...
		return $this->render('MainBundle:Medicaltype:index.html.twig', array(
			'entities' => $entities,
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('MainBundle:Medicaltype:new.html.twig', array(
            'entity' => $entity,
            'form'   => $form->createView(),
        ));
    }
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('MainBundle:Medicaltype')->find($id);
        ...
        return $this->render('MainBundle:Medicaltype:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('MainBundle:Medicaltype:edit.html.twig', array(
            'entity'      => $entity,
