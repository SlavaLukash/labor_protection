...
use App\MainBundle\Form\TraumacauseType;
use App\MainBundle\Filter\TraumacauseFilterType;
...
class TraumacauseController extends Controller
{
    ...
    public function indexAction()
    {
		...
		$filterBuilder = $this->get('doctrine.orm.entity_manager')
			->getRepository('MainBundle:Traumacause')
		...
		return $this->render('MainBundle:Traumacause:index.html.twig', array(
			'entities' => $entities,
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('MainBundle:Traumacause:new.html.twig', array(
            'entity' => $entity,
            'form'   => $form->createView(),
        ));
    }
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('MainBundle:Traumacause')->find($id);
        ...
        return $this->render('MainBundle:Traumacause:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('MainBundle:Traumacause:edit.html.twig', array(
            'entity'      => $entity,
