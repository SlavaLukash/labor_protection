...
use App\MainBundle\Form\EquipmentgroupType;
use App\MainBundle\Filter\EquipmentgroupFilterType;
...
class EquipmentgroupController extends Controller
{
    ...
    public function indexAction()
    {
		...
		$filterBuilder = $this->get('doctrine.orm.entity_manager')
			->getRepository('MainBundle:Equipmentgroup')
		...
		return $this->render('MainBundle:Equipmentgroup:index.html.twig', array(
			'entities' => $entities,
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('MainBundle:Equipmentgroup:new.html.twig', array(
            'entity' => $entity,
            'form'   => $form->createView(),
        ));
    }
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('MainBundle:Equipmentgroup')->find($id);
        ...
        return $this->render('MainBundle:Equipmentgroup:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('MainBundle:Equipmentgroup:edit.html.twig', array(
            'entity'      => $entity,
